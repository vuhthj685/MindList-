<template>
  <div class="toolbarContainer" :class="{ isDark: isDark }">
    <div class="toolbar" ref="toolbarRef">
      <!-- 返回清单按钮 -->
      <div class="toolbarBlock backBlock">
        <div class="toolbarBtn backBtn" @click="goHome" title="返回目标清单首页">
          <span class="icon backIconBox">
            <!-- 用 SVG 画箭头，避免字体渲染导致粗细不稳定 -->
            <!-- 箭头：更长更粗，占方框宽度约60% -->
            <svg width="22" height="14" viewBox="0 0 22 14" fill="none" class="backArrowSvg">
              <path d="M 20,7 L 2,7 M 2,7 L 7,2 M 2,7 L 7,12"
                stroke="#409eff" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
          </span>
          <span class="text">返回清单</span>
        </div>
      </div>
      <!-- 节点操作 -->
